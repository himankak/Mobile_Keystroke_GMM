...
def plot_FAR_FRR():
    ...
    # FAR_list8 = (FAR_FRR_DF['FAR8']).tolist()   #REMOVE FAR_list8 and FRR_list8 for calculation of TEH DATASET
    ...
    plt.plot(x/3.35, x/3.35)

    """ROC CURVE FOR MINMAX AND Z SCORE FOR COMPLETE THREE DATASETS"""
    plt.plot(FRR_list3, FAR_list3, linewidth=3, label='Dataset in [8]', linestyle='-')
    plt.plot(FRR_list1, FAR_list1, linewidth=3, label='Dataset in [9]', linestyle=':')
    plt.plot(FRR_list2, FAR_list2, linewidth=3, label='Dataset in [10]', linestyle='--')
    ...
    # plt.plot(FRR_list1, FAR_list1, linewidth=3, label='KDT', linestyle=':')
    # plt.plot(FRR_list2, FAR_list2, linewidth=3, label='PPT', linestyle='--')
    # plt.plot(FRR_list3, FAR_list3, linewidth=3, label='RPT', linestyle='-')
    # plt.plot(FRR_list4, FAR_list4, linewidth=3, label='P', linestyle='-.')
    # plt.plot(FRR_list5, FAR_list5, label='AoT', marker='s', markerfacecolor='green', markersize=6)
    ...
    # plt.plot(FRR_list1, FAR_list1, linewidth=3, label='KDT', linestyle=':')
    # plt.plot(FRR_list2, FAR_list2, linewidth=3, label='PPT', linestyle='--')
    # plt.plot(FRR_list3, FAR_list3, linewidth=3, label='PRT', linestyle='-')
    # plt.plot(FRR_list4, FAR_list4, linewidth=3, label='RPT', linestyle='-.')
    # plt.plot(FRR_list5, FAR_list5, label='RRT', marker='s', markerfacecolor='green', markersize=6)
    # plt.plot(FRR_list6, FAR_list6, label='PPT$^2$', marker='x', markerfacecolor='black', markersize=6)
    # plt.plot(FRR_list7, FAR_list7, label='PPT$^3$', marker='o', markerfacecolor='cyan', markersize=6)
    ...
    # plt.plot(FRR_list1, FAR_list1, linewidth=3, label='P', marker='o', markerfacecolor='cyan', markersize=8)
    # plt.plot(FRR_list2, FAR_list2, linewidth=3, label='TC', linestyle='--')
    # plt.plot(FRR_list3, FAR_list3, linewidth=3, label='AoT', marker='x', markerfacecolor='yellow', markersize=8)
    # plt.plot(FRR_list4, FAR_list4, linewidth=3, label='ASD', linestyle='-.')
    # plt.plot(FRR_list5, FAR_list5, linewidth=3, label='GSD', marker='s', markerfacecolor='green', markersize=8)
    ...
    # plt.plot(FRR_list8, FAR_list8, linewidth=3, label='All', linestyle='-')

    """ROC CURVE FOR MINMAX AND Z SCORE FOR DIFFERENT FEATURE VECTORS TEH et al."""
    # plt.plot(FRR_list1, FAR_list1, linewidth=3, label='KDT', marker='s', markerfacecolor='cyan', markersize=8)
    # plt.plot(FRR_list2, FAR_list2, linewidth=3, label='PPT', linestyle=':')
    # plt.plot(FRR_list3, FAR_list3, linewidth=3, label='PRT', linestyle='--')
    # plt.plot(FRR_list4, FAR_list4, linewidth=3, label='RPT', linestyle='-.')
    # plt.plot(FRR_list5, FAR_list5, linewidth=3, label='RRT', linestyle='-')
    # plt.plot(FRR_list6, FAR_list6, linewidth=3, color='blue', label='AoT', marker='o', markerfacecolor='yellow', markersize=8)
    # plt.plot(FRR_list7, FAR_list7, linewidth=3, color='green', label='All Time', marker='D', markerfacecolor='orange', markersize=8)

    plt.xlabel("FRR")
    plt.ylabel("FAR")
    plt.legend(fontsize=26, loc='upper right')  # , loc='best', bbox_to_anchor=(0., 0.38, 0.5, 0.5) [0, .10, .20, .30, .40]
    ...
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\COMMON\\FAR_FRR_MIN_MAX_T.pdf', dpi=600, bbox_inches='tight')
    plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\COMMON\\FAR_FRR_Z_SCORE_NEW_T.pdf', dpi=600, bbox_inches='tight')
    ...
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\ANTAL\\FEATURE FUSION\\COMMON_MIN\\FAR_FRR_FEATURES_ANTAL_MIN_MAX_T.pdf', dpi=600, bbox_inches='tight')
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\ANTAL\\FEATURE FUSION\\COMMON_Z\\FAR_FRR_FEATURES_ANTAL_Z_SCORES_T.pdf', dpi=600, bbox_inches='tight')

    """FILE SAVING PROCEDURE FOR THE KDT FAR_FRR TIMING FILES FOR COAKLEY et al."""
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\COAKLEY\\FEATURE FUSION\\COMMON MIN\\TIME\\FAR_FRR_TIME_COAKLEY_MIN_MAX_T.pdf', dpi=600, bbox_inches='tight')
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\COAKLEY\\FEATURE FUSION\\COMMON Z\\TIME\\FAR_FRR_TIME_COAKLEY_Z_SCORES_T.pdf', dpi=600, bbox_inches='tight')

    """FILE SAVING PROCEDURE FOR THE KDT FAR_FRR TOUCH AND MOTION FILES FOR COAKLEY et al."""
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\COAKLEY\\FEATURE FUSION\\COMMON MIN\\TOUCH MOTION\\FAR_FRR_TM_COAKLEY_MIN_MAX_T.pdf', dpi=600, bbox_inches='tight')
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\COAKLEY\\FEATURE FUSION\\COMMON Z\\TOUCH MOTION\\FAR_FRR_TM_COAKLEY_Z_SCORES_T.pdf', dpi=600, bbox_inches='tight')

    """FILE SAVING PROCEDURE FOR THE KDT FAR_FRR ALL FILES FOR TEH et al."""
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\TEH\\FEATURE FUSION\\COMMON_MIN\\FAR_FRR_TEH_MIN_MAX_T.pdf', dpi=600, bbox_inches='tight')
    # plt.savefig('D:\\Keystroke\\FAR_FRR_VALUES\\ROC PLOTS\\TEH\\FEATURE FUSION\\COMMON_Z\\FAR_FRR_TEH_Z_SCORES_T.pdf', dpi=600, bbox_inches='tight')
